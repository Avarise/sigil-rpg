...
### List of Abilities
    ...
    Become caster with one of the following as casting attribute: Intelligence, Wisdom or Charisma. 
    ...
    ENCHANTING GAZE: 
    Your command limit is increased by your charisma score. Additionally, your charms are doubled in duration. 
    Requirements: Mysticism III 
    ...
    THIRD EYE: 
    Consume 1 Focus to gain visions of Zenith for 1 minute. You can use it number of times equal to your proficiency modifier. You regain all uses of this ability after a long rest. 
    I – Gain 60 meters of dark vision. Reveal Zenith sources. 
    II - During visions, consume 1 Mana to gain information about a target, provided they fail Willpower Check. (TODO: Add info gathering mechanics) 
    III -  
    IV – During visions, ignore enemy  

    Gain 100 meters true-sight, +1 to Accuracy. 
    On your turn you may peer into creature by consuming 3 focus. You learn their 
    statistics, and for 1 minute, if a creature has an immunity, you may change it 
    into resistance. You may peer number of times equal to your casting modifier. 
    Requirements: Mysticism IV, 
