### Powers
    ...
    To cast powers, creature has to be a caster, and has to unlock appropriate discipline abilities. 

    Each character can tap into several sources of power to achieve a successful casting. 

### Power Sources
    Tech Powers which manipulate devices, electrical energy and data. 

    Tech Source:
        These common powers control devices, and project energy blasts.
        Focus is the only resource needed to cast these powers, however,
        each power has static cooldown.
        Requirement: Cunning Discipline
    ...
    Meta Source:
        ...
        Requirement: Prowess Discipline
    ...
    Mystic Source:
        ...
        Requirement: Mysticism Discipline
    ...
    Characters with Caster trait, gain 1 Mana per character level and 1 Mana per 2 legendary levels. 

### Tier I Powers
    Available from level character level 1. 
    Powers of this tier require either 1 Focus to use, or consume all
    available focus, which becomes more usable at higher character levels. 


    Tier I: Aim Assistance 
    Source      : Tech (No cooldown) 
    Components  : 1 Focus, S, Concentration 
    Activation  : Turn 

    
    [ Power Effect ] 
    Mark a target you can see. For duration of 12 hours gain 
    +1 Accuracy against that target, and you gain advantage  
    on Perception Checks against that target. 
    ...
    Tier I: Daze 
    Source      : Tech (No cooldown period) 
...
### Tier II Powers
    ...
    Source      : Tech (Short rest cooldown period) 
    ...
    Category   : Tech (Short rest recharge) 
    Components  : 1 Focus, S 
    Activation  : Turn 

    [ Power Effect ] 
    Summon a construct sidekick to aid you in battle and exploration. 
    Sidekick's level equals to your level. 
...
###    Tier IV Powers 
    ...
    Tier IV: Transmute Star 
    Source      : Mystic 
    Components  : 30 Mana, 10 Focus, V, S 
    Activation  : Turn 

    [ Power Effect ] 
    Choose one stellar object of around 3e30 kg mass that you can see. 
    It becomes a Zenith Star. 
