...
| Durability (HP / lvl)  | +1     | +2      | +3       | +4      |
| Fighting Styles        | 1      | 2       | 3        | 4       |

### Fighting Styles

| Name                     | Description                                                                        | Requirements     |
|--------------------------|------------------------------------------------------------------------------------|------------------|
| Archery                  | Bows gain bonus from both STR and DEX modifiers.                                   | Prowess I        |
| Brawling                 | Unarmed/natural weapons deal +2 damage; +2 to Fortitude if used that round.        | Prowess I        |
| Dueling                  | +2 Accuracy with melee weapons if offhand is free.                                 | Prowess I        |
| Defense                  | +1 AC while unarmed. Works with combat shields.                                    | Prowess I        |
| Dual Wielding            | +1 Lethality and +1 Weapon Damage with two weapons.                                | Prowess II       |
| Flanking                 | Advantage on melee attacks if enemy is already engaged.                            | Prowess I        |
| Grappling                | Automatically grapple enemy hit twice in a turn with specific attacks.             | Prowess II       |
| Guardian’s Might         | Use AC instead of STR for shield attacks.                                          | Prowess I        |
| Interception             | Use reaction to reduce damage (1d10 + prof). Requires shield or melee weapon.      | Prowess I        |
| Inquisitive              | Deal extra damage from stealth equal to INT modifier (min 1).                      | Prowess II       |
| Isolation                | Advantage on attacks if enemy has no nearby allies. Triple roll when hidden.       | Prowess III, Inquisitive |
| Marksman                 | +2 Accuracy with ranged weapons.                                                   | Prowess I        |
| Multi-attack Defense     | +2 AC for each consecutive attack made against you.                                | Prowess III, Defense |
| Stagger                  | Fortitude check (DC = damage dealt) or gain "Slow" stack.                          | Prowess I        |
| Thrown Weapon Fighting   | Draw thrown weapon as part of attack; +2 damage on hit.                            | Prowess I        |
| Two-handed Mastery       | Reroll one damage die with two-handed weapons.                                        

### Innate Ability: 
    Attribute Score Improvement: 2/4/6/8 
    Durability: 1/2/3/4 (1 Durability = 1 HP per Level)
    Fighting Styles: 1/2/3/4 Choices
    ...
    List of Fighting Styles:
        ...
        Stagger: 
        Targets of your attacks must succeed a fortitude check with DC equal to damage you dealt with that attack. On failure, target gain one stack of slow. 
        Requires: Prowess I
...
### List of Abilities
    ...
    When dealing damage with powers or attacks, you may sacrifice up to 20% of your HP to deal additional lightning damage. 
    Regain use of this ability on short rest. 
    Requirements: Prowess III 
...
| Stagger                  | Fortitude check (DC = damage dealt) or gain "Slow" stack.                                         | Prowess I        |
| Thrown Weapon Fighting   | Draw thrown weapon as part of attack; +2 damage on hit.                                           | Prowess I        |
| Two-handed Mastery       | Reroll one damage die with two-handed weapons.                                                    | Prowess III      |
...
| Name                   | Description                                                                                      | Requirements |
|------------------------|--------------------------------------------------------------------------------------------------|--------------|
| Slayer’s Will          | Allies (and you) within 15m gain +5m movement after attacking or damaging in combat.             | Prowess II   |
| Presence of Conqueror  | Allies (and you) deal bonus psychic damage equal to CHA. Double vs frightened targets.          | Prowess II   |
...
| Name                 | Description                                                                                      | Requirements |
|----------------------|--------------------------------------------------------------------------------------------------|--------------|
| Crimson Frenzy       | Killing blow allows 10m move; next attack adds 50% overkill damage.                              | Prowess III  |
| Juggernaut           | Resistance to crits; movement never reduced below 20m.                                           | Prowess I    |
| Reckless             | Always gain advantage on melee; become Exposed after each attack.                                | Prowess I    |
| Style Enhancement    | Doubles AC, Accuracy, Damage bonuses from Fighting Styles.                                       | Prowess IV   |
...
| Name              | Description                                                                                          | Requirements            |
|-------------------|------------------------------------------------------------------------------------------------------|-------------------------|
| Action Surge      | Gain extra turn at end of your turn. Initiative penalty [-5/0]. Once/Twice per short rest.           | Prowess I / III         |
| Healing Surge     | Heal 1d6/1d8 per Focus + HP equal to half/your level.                                                | Prowess I / II          |

### Combat Features

| Name                 | Description                                                                                      | Requirements |
|----------------------|--------------------------------------------------------------------------------------------------|--------------|
| Brutal Critical      | Roll 1/2 extra damage dice on melee crit.                                                        | Prowess II / IV |
| Champion             | +1 Accuracy per hit in round (stacks, resets each round).                                        | Prowess IV   |
| Deflect Missiles     | Use reaction to reduce projectile damage by 1d8 + DEX + half level.                              | Prowess II   |
| Demolisher           | 2x damage to structures; resistance to Bludgeoning/Shockwave.                                    | Prowess II   |
| Heavy Strikes        | Knock down exposed/overwhelmed targets with heavy attacks.                                       | Prowess II   |
| Kinetic Acquisition  | +10m speed; +1 physical damage per 10m straight movement before hitting. Cap +100.               | Prowess II   |
| Living Battery       | Extra mana = CON mod. Spend HP for bonus lightning damage.                                       | Prowess III  |
| Iron Fist            | Increases unarmed damage die category.                                                           | Prowess III  |
| One-Two              | +2 Accuracy/Damage/Lethality after unarmed hit on same target.                                   | Prowess II   |
| Reactive Defenses    | Add proficiency to AC as reaction vs melee.                                                      | Prowess I    |
| Pounce               | Skip movement one round to double next round. Jump distance = movement speed.                    | Prowess I    |
| Second Wind          | +10% regen pool; regen cap +15% of max HP.                                                       | Prowess III  |
| Trinity Defence      | Use another save for Fort/Ref/Will; success grants additional effects.                           | Prowess II, Mysticism I, Cunning I |
| Unyielding           | +3 to all saves; -3 damage taken; can’t be incapacitated <20% HP.                                | Prowess IV   |
| Unarmoured Defence   | Gain AC bonus from chosen stat. Effects vary per stat.                                           | Prowess I    |
| Zealous Leader       | Share Surge abilities with one ally in 10m. Requires CHA 13+.                                    | Prowess I    |

### Martial Masteries

| Name                    | Description                                                                                   | Requirements |
|-------------------------|-----------------------------------------------------------------------------------------------|--------------|
| Martial Arts            | Use DEX for unarmed stats if no heavy armor/shield. Unlocks Quick Attack I.                  | Prowess I    |
| Martial Combos (I–IV)   | Reaction attacks spend Focus to act like a turn. Effects scale per tier.                     | Prowess I–IV |
| Meta Powers (I–IV)      | Learn meta powers; CON as casting stat. Gain mana per level and scale DCs.                   | Prowess I–IV |
| Precision Protocol      | Unlocks Precision I. Once per short rest, +10 Accuracy before knowing hit result.            | Prowess II   |
| Advanced Attack Mastery | Unlock Tier II of all basic attack types.                                                     | Prowess IV   |
| Rage (I–IV)             | Enter rage using Focus. Bonuses scale with tier. Gain uses per long rest.                    | Prowess I–IV |
| Perfect Rage            | Rage only ends if you choose or die. Ends with healing. Willpower bonus = CON mod.           | Prowess IV, Rage |
