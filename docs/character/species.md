### Playable Species of SigilRPG

    Each species is combination of starting statistics,
    and set of genetic traits. All of these can be modified,
    applied and removed via Disciplines, powers and technology.

    To respecialize statistics, character may undergo Neural Remap,
    Rebirth, and Ascendance. 
    When going to sleep in world of SigilRPG,
    playable species appear to be able to partake in Shared Dream.
...
### Elph
    ...
    Ascension Perk: +1 to Durability/Skills/Disciplines/Genes
...
### List of Origins
    ...
    Bounty Hunter:
        - Jet Pack or Skimming Rings
        - Grappling Hook 
    
    Criminal:

    Dreamborn:
        Consciousness born within Shared Dream of Sigil.
        Later, you were given a body in the physical world via
        ritual, or via respawn clinic.
...
### Genes
    Acute Vision:
    Your Perception checks that rely on vision, gain advantage. 

    Apex Predator:
    Natural weapons and unarmed strikes overwhelm enemies on a critical strike. 

    Aquatic Adaptation:
    Gain water breathing, and swim speed equal to your walk speed. 
    ...
    Glide Wings: 
    First stage of wing development, allows gliding through atmosphere,
    provided it is dense enough.
    ...
    Burrower
    You may travel through soft ground with your normal running speed, 
    and at half that rate through hard or solid ground, such as bedrock. 
    Lose 10 meters of base movement. 

    Winged Flight 
    Gain flight speed equal to running speed. 
    Requires: Glide Wings 

    Add gene substrait item as condensed form of gene: cost multiple fuel rods 

### Creature Types
    Beast (Animal): 
    Intelligent creatures that create natural fauna of the universe. 
...
Each character in SigilRPG begins by selecting a species.
This choice determines your **Durability**, **Rest Cycle**, and unlocks specific **Traits**.

| Species       | Description                                                             | Durability | Rest Time                 | Features                           |
|---------------|-------------------------------------------------------------------------|------------|----------------------------|-------------------------------------|
| **Elph**     | Sleek, humanoid mix of several proto-elphar species                     | 5          | 1h short / 8h long         | Nanite Symbiosis<br> Shared Dreamer |
| **Arthon**   | Isolated lineage of Elphs                                               | 5          | 1h short / 8h long         | Nanite Symbiosis<br> Shared Dreamer |
| **Sildorian** | Tall, stoic giants with crystalline bone and exoskeleton                | 7          | 5m short / 16h long        | Crystalline <br> Disciplined        |
| **Ash Sarite**| Lava-hardened Sildorians from the Amorthis system                       | 7          | 6h short / 6h long         | Crystalline <br> Living Furnace     |
